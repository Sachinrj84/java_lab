...
Connection conn = 
DriverManager.getConnection("jdbc:mysql://localhost:3306/demo", "root", "sachin@84");
if (conn != null)
{
...
Statement stmt2;
Class.forName("com.mysql.jdbc.Driver");
Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/demo", "root", "sachin@84");
if (conn != null) 
{
System.out.println("Connection successful !!!");
